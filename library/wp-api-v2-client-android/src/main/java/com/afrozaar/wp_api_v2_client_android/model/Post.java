...
public class Post extends WPObject<Post> {
    ...
    public static final String JSON_FIELD_TUT_SUBJECT = "tut_subject";
    public static final String JSON_FIELD_FEATURED_IMAGE_URL = "featured_image_url";
    public static final String JSON_FIELD_VIDEO_URLS = "video_urls";
    ...
    public static final String JSON_FIELD_PAYPLANS = "payment_plan";
    ...
    /**
     * The featured_image_url for the object.
     */
    ...
    public Post withFeaturedImageUrl(String featuredImageUrl) {
    ...
    private Media betterFeaturedMedia;

    public void setBetterFeaturedMedia(Media betterFeaturedMedia) {
        this.betterFeaturedMedia = betterFeaturedMedia;
    }

    public Media getBetterFeaturedMedia() {
        return betterFeaturedMedia;
    }

    public Post withBetterFeaturedMedia(Media betterFeaturedMedia) {
        setBetterFeaturedMedia(betterFeaturedMedia);
        return this;
    }
     ...
     */
    @SerializedName(JSON_FIELD_TUT_SUBJECT)
    private String tutSubject;

    public void setTutSubject(String tutSubject) {
        this.tutSubject = tutSubject;
    }

    public String getTutSubject() {
        return tutSubject;
    }
    ...
    @SerializedName(JSON_FIELD_VIDEO_URLS)
    ...
    @SerializedName(JSON_FIELD_PAYPLANS)
    private List<Long> payplans;

    public void setPayplans(List<Long> payplans) {
        this.payplans = payplans;
    }

    public List<Long> getPayplans() {
        return payplans;
    }
    ...
    public Post(Parcel in) {
        ...
        tutSubject = in.readString();
        categories = new ArrayList<>();
        in.readList(categories, Long.class.getClassLoader());
        payplans = new ArrayList<>();
        in.readList(payplans, Long.class.getClassLoader());
        videoUrls = new ArrayList<>();
        in.readList(videoUrls, String.class.getClassLoader());
        tags = new ArrayList<>();
        in.readList(tags, Long.class.getClassLoader());
        betterFeaturedMedia = in.readParcelable(Media.class.getClassLoader());
    ...
    public static Map<String, Object> mapFromFields(Post post) {
        ...
        Validate.validateMapEntry(JSON_FIELD_FEATURED_IMAGE_URL, post.getFeaturedImageUrl(), builder);
        Validate.validateMapEntry(JSON_FIELD_LINKS, post.getLinks(), builder);
        Validate.validateMapEntry(JSON_FIELD_BETTER_FEATURED_IMAGE, post.getBetterFeaturedMedia(), builder);
        Validate.validateMapEntry(JSON_FIELD_TUT_SUBJECT, post.getTutSubject(), builder);
        Validate.validateMapEntry(JSON_FIELD_VIDEO_URLS, post.getVideoUrls(), builder);
