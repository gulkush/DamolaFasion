...
public class WpClientRetrofit {
    ...
    public void getPosts(Map<String, String> params, WordPressRestResponse<List<Post>> callback, boolean asc) {
    ...
    public void getPostsForMetaKeyValue(String key, String value, WordPressRestResponse<List<Post>> callback) {
        doRetrofitCall(mRestInterface.getPostsForMetaKeyValue(key, value), callback);
    }
