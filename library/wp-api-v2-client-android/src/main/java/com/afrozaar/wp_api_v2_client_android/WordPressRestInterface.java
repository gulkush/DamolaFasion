...
public interface WordPressRestInterface {
     ...
     */
    @GET("tutorials/counts")
    Call<PostCount> getPostCounts();

    @GET("tutorials")
    Call<List<Post>> getPostsForMetaKeyValue(@Query("filter[meta_key]") String metakey, @Query("filter[meta_value]") String metavalue);
}
